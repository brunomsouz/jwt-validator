...
class JwtControllerIntegrationTest {
    ...
    @Test
    void testValidateJwtValid() throws Exception {
    ...
    @Test
    void testValidateJwtInvalid() throws Exception {
    ...
    @Test
    void testValidateJwtInvalidClaimName() throws Exception {
    ...
    @Test
    void testValidateJwtInvalidAdditionalClaim() throws Exception {
    ...
    @Test
    void testValidateJwtBadRequestNullJwt() throws Exception {
        JwtValidationRequest request = new JwtValidationRequest(null);
    ...
    @Test
    void testValidateJwtBadRequestEmptyJwt() throws Exception {
